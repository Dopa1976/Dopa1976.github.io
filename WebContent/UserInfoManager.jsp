	...
	<div class="off-canvas-wrapper">
		<div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
			...
			<div class="off-canvas-content" data-off-canvas-content>
				...
				<div id="app" >
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						...
						<div STYLE="width: 100%; height: 100%;line-height: 100% ;">
							<form>
							   <div STYLE="width: 5%; height: 100%; float: left;margin-left: 100px; margin-top:25px;font-size: 16px;">搜索：</div>
							   <div STYLE="width: 20%; height: 100%; float: left; margin-top:20px;"><input type="text" name="menu.menuName" class="form-control" v-model="keywords" id="search"></div>
                            ...
                            <div STYLE="width: 8%; height: 100%; float: left;margin-left: 5px; margin-top:20px;">
                               <input class="btn btn-primary" type="button" onclick="window.location.href='quertAllRole'" value="添加" />
                            </div>
						</div>
					</div>
		 	...
		 	<s:iterator var="userInfoManager" value="userInfoList" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>
								<td><s:property value="#userInfoManager.userAccount" /> <input
									type="radio"></td>
								<td><s:property value="#userInfoManager.userPassword" /></td>
								<td><s:property value="#userInfoManager.roleName" /></td>
								<td><a
									href="?ids=<s:property value="#userInfoManager.id"/>">删除</a></td>
							</tr>
						</s:iterator>
            ...
            //添加用户
                 ...
                 function queryName(){
                     ...
                     form.action = "queryBuCondition"+"?menuName="+search;
                	 form.method = "post";
                	 form.submit();
                 } 
