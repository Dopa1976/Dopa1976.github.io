        ...
        <div class="off-canvas-content" data-off-canvas-content>
            ...
            <div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						...
						<div STYLE="float:right;margin-right: 100px;margin-top: 30px;"><input class="btn btn-primary" type="button" onclick="window.location='batPeoAction?ids=${session.batchID}'"  value="返回" /></div>						
</div>
                       ...
                       <table class="table table-bordered table-hover table-striped">
						...
						<s:iterator var="bp" value="bpList" status="st">
							<tr>
								...
								<td><s:property value="#bp.userAccount" /> </td>
								<td>
								    <s:set var="ss" value="#bp.status"/>
								    <s:if test="#ss==1">以审核</s:if>
								    <s:if test="#ss==0">未审核</s:if>
								</td>
							
								<td><a href="batPeoAddAction?batchId=${session.batchID}&&userId=<s:property value='#bp.userId' />">添加</a></td>
							</tr>
						</s:iterator>
						</table>
						</div>
                ...
                function queryName(){
                     ...
                     form.action = "peoQueryName"+"?name="+search;
                	 form.method = "post";
                	 form.submit();
                 } 
