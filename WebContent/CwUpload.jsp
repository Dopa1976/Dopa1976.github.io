					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
                       ...
                       <form action="uploadAction" method="post" enctype="multipart/form-data">   
                          ...
                          <tr>
                             ...
                             <td>
                              <input type="text" name="courseware.cwName" style="font-size: 15px;"/>                             
                             </td>
                          </tr>
                          <tr>
                             <td>所属课程：</td>
                             <td><s:select list="courseList" listKey="id" listValue="courseName" name="courseId" theme="simple" cssStyle="height:30px;" /></td>
                          </tr>
                          <tr>
                             <td> 学分：</td>
                             <td><input type="text" name="courseware.cwCredit" style="font-size: 15px;" /></td>
                          </tr>
                          <tr>
                             <td> 种类：</td>
                             <td>
                                 <s:select	name="courseware.cwType"  list="#{'1':'视频','0':'其它'}" theme="simple" cssStyle="height:30px;" />
                             </td>
                          </tr>
                          <tr>
                             <td colspan="2" align="right">
                             <input type="submit" value="上传" class="update"/>
                                &nbsp;&nbsp;&nbsp;
                              <input type="button" value="返回" class="update" onclick="window.location='CwqueryAll'"/>
                             </td>
                           </tr>
                          </table>
