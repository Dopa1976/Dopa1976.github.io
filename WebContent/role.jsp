				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left: 730px">角色管理</h3>
						</div>
						 <div
							STYLE="margin-left: 50px; width: 20%; height: 100%; float: left; margin-top: 20px;">
							<form id="addForm" style="margin: 0px; display: inline;">

								
								<input type="text" class="form-control" v-model="name" placeholder="搜索角色"
									name="role.roleName"
									style="float: left; width: 200px; margin-right: 10px;">
								<input type="button" value="添加" class="btn btn-primary"
									onclick="add()" style="float: left;" />
							</form>
						</div>
						
						<div STYLE="width: 20%; height: 50%; float: left;margin-top: 20px;">
							<form>

                                  
								<label>
								   
								        <input type="text"	name="role.roleName" placeholder="搜索角色"  class="form-control"	v-model="keywords" id="search" v-focus v-color="'green'" >
					...
					<table class="table table-bordered table-hover table-striped">
						...
						<s:iterator var="role" value="rolelist" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>

								<td><s:property value="#role.roleName" /></td>
								<td>
								<a href="roleModifyAction?ids=<s:property value="#role.id"/>">修改</a>&nbsp;&nbsp;&nbsp;
								<a href="deleteRole?ids=<s:property value="#role.id"/>">删除</a>
								</td>			
