				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left: 730px">批次课件管理</h3>
						</div>
						
						
						<div STYLE="width: 22%; height: 100%; float: left; margin-top:20px;margin-left: 50px;" >
							<form >
							 <div style="float: left;line-height: 30px;font-size: 15px;">课件名：</div> 
								<label>
								<input type="text"
  class="form-control"
						...
						&nbsp; &nbsp; &nbsp;
                       <div STYLE="margin-left: 50px; width: 20%; height: 100%; float: left;margin-top: 20px;">
							
                                <input type="button" value="添加" class="btn btn-primary" onclick="window.location='queryAddCouAction?batchId=${session.ba}'" style="float: left;"/>
					...
					<input type="hidden" id="batchId" value="${session.ba}" />
					     <tr>
							<th>ID</th>
							<th>课件名称</th>
							<th>学分</th>
						...
						<s:iterator var="bc" value="cwList" status="st"> 
                             <tr> 
                                <td><s:property value="#st.index+1" /></td>
								<td><s:property value="#bc.cwName" /> </td>
								<td><s:property value="#bc.cwCredit" /></td>
								<td><s:set var="cw" value="#bc.cwType"/>
								     <s:if test="#cw==1">视频</s:if>
								     <s:if test="#cw==0">其他</s:if>
								</td>
								<td><a href="deleteCou?batchId=<s:property value='#bc.batchId'/>&&cwId=<s:property value='#bc.cwId' />">删除</a>
								</td>
                             </tr> 
                          </s:iterator>      
            ...
            //添加用户
                 ...
                 function queryName(){
                     ...
                     form.action = "queryBCName"+"?name="+search+"&&batchId="+batchId;
                	 form.method = "post";
                	 form.submit();
                 }
