		...
		<div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
			...
			<div class="off-canvas-content" data-off-canvas-content>
				...
				<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left:50%">用户角色管理</h3>
						</div>
							<div
								STYLE="margin-left: 50px; width: 100%; height: 100%; float: left; margin-top: 20px;">
								<form id="addForm" style="margin: 0px; display: inline;">

   
  <div style="float: left; line-height: 30px; margin-right: 5px; font-size: 20px;" >搜索:</div>
  <input type="text"  class="form-control" v-model="name" id="search"
										name="userRole.roleName"
										style="float: left; width: 200px; margin-right: 10px;">
									<input type="button" value="查询" class="btn btn-primary"
										onclick="queryName()" style="float: left;" />
								</form>
								&nbsp; &nbsp; &nbsp;
						<div STYLE="width: 20%; height: 100%; margin-left:20px; float: left;">
							<form>
					 <div class="main">
								<input  id="btn_showlogin" onclick="window.location.href='addqueryUserRole'" type="button" value="新增" class="btn btn-primary"  />
                     </div>
							</form>
							</div>
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<s:iterator var="userRole" value="userRoleVolist" status="st">
								<tr>
									<td><s:property value="#st.index+1" /></td>
									<td><s:property value="#userRole.userAccount"/> <input
										type="radio"></td>
									<td><s:property value="#userRole.roleName"/> <input
										type="radio"></td>
		<td><a href="rdeleteById?ids=<s:property value="#userRole.id"/>">删除</a></td>
								</tr>
							</s:iterator>
...
<script>
                 ...
                 function queryName(){
                     ...
                     form.action = "queryByName"+"?roleName="+search;
                	 form.method = "post";
                	 form.submit();
                 }
