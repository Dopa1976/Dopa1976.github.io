            ...
            <div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left: 730px">设置课件</h3>
						</div>	
						<div STYLE="float:right;margin-right: 100px;margin-top: 30px;"><input class="btn btn-primary" type="button" onclick="window.location='batCwAction?ids=${session.ba}'" value="返回"/></div>          					
</div>
                       ...
                       <table class="table table-bordered table-hover table-striped">
						...
						<s:iterator var="bc" value="cwList" status="st">
							<tr>
								...
								<td><a href="batCouAddAction?batchId=${session.ba}&&cwId=<s:property value='#bc.cwId' />">添加</a></td>
							</tr>
						</s:iterator>
						</table>
						</div>
