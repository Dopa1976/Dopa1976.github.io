			...
			<div class="off-canvas-content" data-off-canvas-content>
				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
                       ...
                       <s:form action="Baadd" method="post" theme="simple" >   
                 
                          <table>
                          <tr>
                            <td align="right">批次名称:</td>
                            <td>
                            <s:textfield name="batch.batchName" cssClass="courseText"></s:textfield>
                            </td>
                          </tr>
                          <tr>
                             <td align="right">开始时间：</td>
                             <td>
                              <s:textfield  name="batch.starTime" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                           <tr>
                             <td align="right">结束时间：</td>
                             <td>
                              <s:textfield  name="batch.endTime" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                           <tr>
                             <td align="right">资格分数：</td>
                             <td>
                              <s:textfield  name="batch.score" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                          <tr>
                             <td colspan="2" align="right">
                              <s:submit value="确定" cssClass="update"></s:submit>
                                &nbsp;&nbsp;&nbsp;
                              <input type="button" value="返回" class="update" onclick="back()"/>
                           </tr>
                          </table>
