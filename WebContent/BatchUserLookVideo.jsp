				...
				<div id="app" style="height: 590px;">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						...
						<div STYLE="width: 100%; height: 100%; line-height: 100%;">
							<form>
								<div
									STYLE="width: 5%; height: 100%; float: left; margin-left: 100px; margin-top: 25px; font-size: 16px;">搜索：</div>
								<div
									STYLE="width: 20%; height: 100%; float: left; margin-top: 20px;">
									<input type="text" name="menu.menuName" class="form-control"
										v-model="keywords" id="search">
								</div>
								<div
									STYLE="width: 8%; height: 100%; float: left; margin-left: 5px; margin-top: 20px;">
						...
						<!-- 	<div
								...
								<input class="btn btn-primary" type="button"
									onclick="window.location.href=''" value="添加" />
							</div> -->
						</div>
					</div>
					...
					<table class="table table-bordered table-hover table-striped">
						...
						<s:iterator var="lookVideoList" value="lookVideoList" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>
								<td><s:property value="#lookVideoList.cwName" /></td>
								<td><s:property value="#lookVideoList.cwCredit" /></td>
								<td align="center"><s:if test="#lookVideoList.finish==0">
										未看完
									</s:if> <s:else>已看完</s:else></td>
									<td><a href="innerLook?cw_id=<s:property value="#lookVideoList.id"/>&BatchId=<s:property value="BatchId"/>">进入观看</a></td>
							</tr>
