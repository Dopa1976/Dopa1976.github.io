	...
	<div class="off-canvas-wrapper">
		<div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
			...
			<div class="off-canvas-content" data-off-canvas-content>
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						...
						<div STYLE="width: 100%; height: 100%;line-height: 100% ;">
							<form>
							   ...
							   <div STYLE="width: 20%; height: 100%; float: left; margin-top:20px;margin-left: 50px;"><input type="text" placeholder="角色" class="form-control" v-model="keywords" id="search"></div>
							   <div STYLE="width: 5%; height: 100%; float: left;margin-left: 5px; margin-top:20px;"><input type="button" value="查询" class="btn btn-primary"	onclick="queryName()" /></div> 
							</form>
                            <div STYLE="width: 5%; height: 100%; float: left;margin-left: 5px; margin-top:20px;">
		 	...
		 	<s:iterator var="userManager" value="userManagerList" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>
								<td><s:property value="#userManager.roleName" /> <input
									type="radio"></td>
								<td><s:property value="#userManager.menuName" /></td>
								<td><a
									href="deleteUserManagerMenu?ids=<s:property value="#userManager.id"/>">删除</a></td>
							</tr>
						</s:iterator>
            ...
            //添加用户
                 ...
                 function queryName(){
                     ...
                     form.action = "queryManagerByname"+"?menuName="+search;
                	 form.method = "post";
                	 form.submit();
                 } 
