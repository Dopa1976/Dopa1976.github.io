				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
						<div class="panel-heading" STYLE="height: 100%;">
							<h3 class="panel-title" STYLE="margin-left: 730px">添加菜单</h3>
						</div>
					</div>
                       <s:form action="menuAddAction" method="post" theme="simple" >   
                         <s:hidden name="menu.id"></s:hidden>
                          <table>
                          <tr>
                            <td align="right">菜单名:</td>
                            <td>
                            <s:textfield name="menu.menuName" cssClass="courseText"></s:textfield>
                            </td>
                          </tr>
                          <tr>
                             <td align="right">菜单等级：</td>
                             <td>
                              <s:textfield  name="menu.sortNo" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                          <tr>
                            <td align="right">地址：</td>
                            <td>
                                <s:textfield  name="menu.address" cssClass="courseText"></s:textfield>
                            </td>
                          </tr>
                          <tr>
                             <td align="right">父级菜单：</td>
                             <td><s:select name="ids" list="menuList" listKey="id" listValue="menuName" headerKey="" headerValue="选择父级菜单" cssStyle="height:33px;"></s:select></td>
                          </tr>
                          ...
                          <tr>
                             ...
                             <s:submit value="添加" cssClass="update"></s:submit>
                                &nbsp;&nbsp;&nbsp;
                              <input type="button" value="返回" onclick="window.location='menuQueryAction'" class="update"/>
                           </tr>
                          </table>
