				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
						<div class="panel-heading" STYLE="height: 100%;">
							<h3 class="panel-title" STYLE="margin-left: 730px">修改菜单</h3>
						</div>
					</div>
					<s:form action="menuUpdateAction" method="post" theme="simple">
						<s:hidden name="menu.id"></s:hidden>
						<table>
							<tr>
								<td align="right">菜单名:</td>
								<td><s:textfield name="menu.menuName" cssClass="courseText"></s:textfield>
								</td>
							</tr>
							
							<tr>
								<td align="right">地址：</td>
								<td><s:textfield name="menu.address" cssClass="courseText"></s:textfield>
								</td>
							</tr>

							<tr>
								<td colspan="2" align="right"><s:submit value="修改"
										cssClass="update"></s:submit> &nbsp;&nbsp;&nbsp; <input
									type="button" value="返回"
									onclick="window.location='menuQueryAction'" class="update" />
							</tr>
						</table>
