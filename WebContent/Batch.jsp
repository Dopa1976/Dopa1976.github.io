            ...
            <div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left: 730px">批次管理</h3>
						</div>
						...
						<div STYLE="width: 25%; height: 50%; float:left;margin-top: 20px; margin-left: 50px;">
							<form>								
								...
								<input type="text"  placeholder="批次名称"
									   name="batch.batchName"  class="form-control" 
					    ...
					    <div STYLE="width: 25%; height: 50%; float:left;margin-top: 20px; margin-left: 20px;">
					       <input type="button"  value="添加" class="btn btn-primary" onclick="window.location='batchAdd.jsp'"/>
					    </div>
                       ...
                       <table class="table table-bordered table-hover table-striped">
						...
						<s:iterator var="batch" value="batchList" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>
								<td><s:property value="#batch.batchName" /> </td>
								<td>
								  <fmt:formatDate pattern="yyyy-MM-dd" value="${starTime}"/>
								</td>
								<td>
								  <fmt:formatDate pattern="yyyy-MM-dd" value="${endTime}"/>
								 
								</td>
								<td><s:property value="#batch.score" /></td>
								
								<td>
								    <a href="batPeoAction?ids=<s:property value="#batch.id"/>&&peo=1">设置人员</a>
								      &nbsp;&nbsp;&nbsp;
								    <a href="batCwAction?ids=<s:property value="#batch.id"/>&&cwo=1">设置课件</a>
								</td>
								<td><a href="Badelete?ids=<s:property value="#batch.id"/>">删除</a></td>
                ...
                function queryName(){
                     ...
                     form.action = "BaqueryName"+"?batchName="+search;
                	 form.method = "post";
                	 form.submit();
                 } 
