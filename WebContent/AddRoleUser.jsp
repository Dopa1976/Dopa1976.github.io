				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
						<div class="panel-heading" STYLE="height: 100%;">
							<h3 class="panel-title" STYLE="margin-left: 730px">用户角色管理</h3>
						</div>
					</div>
                       <s:form action="addUserRole" method="post" theme="simple" >   
                         <s:hidden name="userRole.id"></s:hidden>                         
                          <table>
                          <tr>
                            <td align="right">用户账号:</td>
                            <td>
                            <s:select name="userId" cssClass="courseText" list="userInfoList" listKey="id" listValue="userAccount"></s:select>
                            </td>
                          </tr>
                          <tr>
                             <td align="right">角色名称：</td>
                             <td>
                            <s:select name="roleId" list="roleList" cssClass="courseText"  listKey="id" listValue="roleName"  />
                             </td>
                          </tr>
                          <tr>
                             ...
                             <s:submit value="添加" cssClass="update"></s:submit>
                                &nbsp;&nbsp;&nbsp;
                              <input type="button" value="返回" class="update" onclick="window.location='queryUserRoleAll'"/>
                           </tr>
                          </table>
