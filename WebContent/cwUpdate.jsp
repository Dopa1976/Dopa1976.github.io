	...
	<div class="off-canvas-wrapper">
		<div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
            ...
            <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
             ...
             <li>
                 <a href="#"><i class="fa fa-film"></i>${menu1.menuName}</a> 
                  
                  
                           <c:if test="${fn:length(menu1.children) > 0}"><!-- 判断是否有子菜单 -->
                           <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                             <c:forEach var="menu2" items="${menu1.children}" varStatus="e"> 
	                               <li>
	                                    <a href="${menu2.address }"><i class="fa fa-home"></i>${menu2.menuName}</a>
			...
			<div class="off-canvas-content" data-off-canvas-content>
				...
				<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
                       ...
                       <s:form action="cwUpdateAction" method="post" theme="simple" >   
                         <s:hidden name="courseware.id"></s:hidden>
                          <table>
                          <tr>
                            <td align="right">课件名:</td>
                            <td>
                            <s:textfield name="courseware.cwName" cssClass="courseText"></s:textfield>
                            </td>
                          </tr>
                          <tr>
                             <td align="right">学分：</td>
                             <td>
                              <s:textfield  name="courseware.cwCredit" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                          <tr>
                             <td align="right">地址：</td>
                             <td>
                              <s:textfield  name="courseware.cwAddress" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                          <tr>
                             <td align="right">种类：</td>
                             <td>
                              <s:textfield  name="courseware.cwType" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                          <tr>
                             <td align="right">课程：</td>
                             <td>
                              <s:select name="courseId" list="list" cssClass="courseText" listKey="id" listValue="courseName" value="courseId"></s:select>
                             </td>
                          </tr>
                          <tr>
                             ...
                             <s:submit value="修改" cssClass="update"></s:submit>
                                &nbsp;&nbsp;&nbsp;
                              <input type="button" value="返回" class="update"/>
                           </tr>
                          </table>
