            ...
            <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
                ...
                <li>
                    ...
                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                        ...
                        <li><a href="profile-about-me.jsp"><i class="fa fa-magic"></i>关于我的简介</a></li>
                        <li><a href="profile-comments.html"><i class="fa fa-magic"></i>个人资料评论</a></li>
                        <li><a href="profile-settings.jsp"><i class="fa fa-magic"></i>档案设置</a></li>
                    </ul>
                </li>
                    ...
                    <div class="large-12 columns">
                        <nav aria-label="You are here:" role="navigation">
                            <ul class="breadcrumbs">
                                ...
                                <li>
                                    <span class="show-for-sr">Current: </span> 关于我
                                </li>
                            </ul>
                        </nav>
                    </div>
                                ...
                                <div class="widgetBox">
                                    ...
                                    <div class="widgetContent">
                                        <ul class="profile-overview">
                                            <li class="clearfix"><a class="active" href="#"><i class="fa fa-user"></i>关于我</a></li>
                                            ...
                                            <li class="clearfix"><a href="profile-settings.html"><i class="fa fa-gears"></i>档案设置</a></li>
                            ...
                            <div class="large-12 columns">
                                ...
                                <div class="description">
                                    ...
                                    <div class="site profile-margin">
                                        <button><i class="fa fa-globe"></i>地址</button>
                                        <a href="#" class="inner-btn">四川省内江市</a>
                                    </div>
                                    <div class="email profile-margin">
                                        <button><i class="fa fa-envelope"></i>Email</button>
                                        <span class="inner-btn">chenglaingshibili@126.com</span>
                                    </div>
                                    <div class="phone profile-margin">
                                        <button><i class="fa fa-phone"></i>电话</button>
                                        <span class="inner-btn">13612345678</span>
                                    </div>
                                    <div class="socialLinks profile-margin">
                                        <button><i class="fa fa-share-alt"></i>我的社交</button>
