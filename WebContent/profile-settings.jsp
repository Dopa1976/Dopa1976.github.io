        ...
        <div class="off-canvas position-left light-off-menu dark-off-menu" id="offCanvas" data-off-canvas>
            ...
            <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
                ...
                <li>
                    ...
                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                        <li><a href="blog-single-post.html"><i class="fa fa-edit"></i>博客单帖</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-magic"></i>个人资料</a>
                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                        <li><a href="profile-page-v2.html"><i class="fa fa-magic"></i>个人资料</a></li>
                        <li><a href="profile-about-me.html"><i class="fa fa-magic"></i>关于我的简介</a></li>
                        <li><a href="profile-comments.html"><i class="fa fa-magic"></i>个人资料评论</a></li>
                        <li><a href="profile-settings.html"><i class="fa fa-magic"></i>档案设置</a></li>
                    </ul>
                </li>
                <li><a href="about-us.html"><i class="fa fa-user"></i>关于我们</a></li>
                <li><a href="contact-us.html"><i class="fa fa-envelope"></i>联系我们</a></li>
            </ul>
                    ...
                    <div class="large-12 columns">
                        <nav aria-label="You are here:" role="navigation">
                            <ul class="breadcrumbs">
                                <li><i class="fa fa-home"></i><a href="demo.html">首页</a></li>
                                <li>
                                    <span class="show-for-sr">Current: </span> 档案设置
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <section class="topProfile topProfile-inner" style="background: url('images/profile-bg1.png') no-repeat;">
                <div class="row">
                    <div class="large-12 columns">
                        <div class="upload-bg">
                            <form method="post">
                                <label for="topfileupload" class="btn-upload"><i class="fa fa-camera"></i><span>更改你的封面图片</span></label>
                    ...
                    <div class="row secBg">
                        <div class="large-12 columns">
                            <div class="profile-author-img">
                                <img src="images/120x110.png" alt="profile author img">
                                <form method="post">
                                    <label for="imgfileupload" class="btn-upload"><i class="fa fa-camera"></i><span>更换你的头像</span></label>
                                ...
                                <div class="widgetBox">
                                    ...
                                    <div class="widgetContent">
                                        <ul class="profile-overview">
                                            <li class="clearfix"><a href="profile-about-me.html"><i class="fa fa-user"></i>关于我</a></li>
                                            <li class="clearfix"><a href="profile-video.html"><i class="fa fa-video-camera"></i>我的课程 <span class="float-right">36</span></a></li>
                                            <li class="clearfix"><a href="#"><i class="fa fa-heart"></i> 我的收藏<span class="float-right">50</span></a></li>

                                            <li class="clearfix"><a href="#"><i class="fa fa-comments-o"></i>我的评论<span class="float-right">26</span></a></li>
                                            <li class="clearfix"><a class="active" href="#"><i class="fa fa-gears"></i>档案设置</a></li>

                                        </ul>
                                        <a href="demo.html" class="button"><i class="fa fa-plus-circle"></i>注销</a>
                                    </div>
                                </div>
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="setting-form-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="medium-6 columns">
                                                            <label>地址:
                                                                <input type="url" placeholder="请输入您的地址..">
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="medium-12 columns">
                                                            <label>个人描述:
                                                                <textarea>这个人很懒，什么也没留下。</textarea>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="setting-form-inner">
                                                    <button class="button expanded" type="submit" name="setting">立即更改</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <div class="widgetBox">
                            ...
                            <div class="widgetContent">
                                <div class="media-object">
                                    <div class="media-object-section">
                                        <div class="recent-img">
                                            <img src= "images/teach/400x300_1.png" alt="recent">
                                    ...
                                    <div class="media-object-section">
                                        <div class="media-content">
                                            <h6><a href="#">点击观看课程.</a></h6>
                                            <p><i class="fa fa-user"></i><span>孙笑川</span><i class="fa fa-clock-o"></i><span>5 january 16</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="media-object">
                                    <div class="media-object-section">
                                        <div class="recent-img">
                                            <img src= "images/teach/400x300_5.png" alt="recent">
                                            <a href="#" class="hover-posts">
                                                <span><i class="fa fa-play"></i></span>
                                            </a>
                                        </div>
                                ...
                                <div class="media-object">
                                    <div class="media-object-section">
                                        <div class="recent-img">
                                            <img src= "images/teach/400x300_3.png" alt="recent">
                                            <a href="#" class="hover-posts">
                                                <span><i class="fa fa-play"></i></span>
                                            </a>
                                        </div>
