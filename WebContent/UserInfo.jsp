				...
				<div id="app" style="height: 590px;">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left: 730px">用户管理</h3>
						</div>
						<div STYLE="width: 100%; height: 100%; line-height: 100%;">
							<form>
								<div STYLE="width: 20%; height: 100%; float: left; margin-top: 20px;margin-left: 50px;">
									<input type="text"  class="form-control" v-model="keywords" id="search" placeholder="用户名">
								</div>
					...
					<table class="table table-bordered table-hover table-striped">
						...
						<s:iterator var="userInfoList" value="userInfoList" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>
								<td><s:property value="#userInfoList.userAccount" /> <input
									type="radio"></td>
								<td><s:if test="#userInfoList.status!=1">
										<a	href="auditing?id1=<s:property value="#userInfoList.id"/>">审核</a>
									</s:if> <s:else>已通过审核</s:else></td>								
								<td><a href="deleteUserInfo?id=<s:property value="#userInfoList.id"/>">删除</a></td>
							</tr>
						</s:iterator>
