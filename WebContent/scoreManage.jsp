	...
	<div class="off-canvas-wrapper">
		<div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
			...
			<div class="off-canvas-content" data-off-canvas-content>
							...
							<div class="sticky topnav topnav-dark" data-sticky
								...
								<div class="show-for-large topbar-full topbar-dark clearfix"
									...
									<div class="top-bar-left toplogo">
										<ul class="menu">
											<li class="menu-text"><a href="#"><img	src="images/logo-small.png" alt="logo"></a></li>
										</ul>
									</div>
				...
				<div id="app" style="height: 590px;">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 20%;">
						<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left: 730px">成绩管理</h3>
						</div>
						<div STYLE="width: 100%; height: 100%;line-height: 100% ;">
							<form>
							   <div STYLE="width: 5%; height: 100%; float: left;margin-left: 100px; margin-top:25px;font-size: 16px;">用户：</div>
							   <div STYLE="width: 20%; height: 100%; float: left; margin-top:20px;"><input type="text" class="form-control" v-model="keywords" id="search"></div>
							   <div STYLE="width: 8%; height: 100%; float: left;margin-left: 5px; margin-top:20px;"><input type="button" value="查询" class="btn btn-primary"	onclick="queryName()" /></div> 
							</form>
                            <div STYLE="width: 8%; height: 100%; float: left;margin-left: 5px; margin-top:20px;">
                               <input class="btn btn-primary" type="button" value="添加" onclick="add()"/>
                            </div>
                            <div STYLE="width: 8%; height: 100%; float: left;margin-left: 5px; margin-top:20px;">
                                <a href="ScoreUpload.jsp"> <button class="btn btn-default" type="button"><em class="glyphicon glyphicon-align-justify"></em> 成绩上传</button></a>
                            </div>
		 	...
		 	<s:iterator var="sv" value="scoreVoList" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>
								<td><s:property value="#sv.userAccount" /></td>
								<td><s:property value="#sv.score" /></td>
								<td><s:property value="#sv.batchName" /></td>
								<td>
								<%-- <a	href="scoreModifyQueryAction?id=<s:property value="#sv.id"/>">修改</a>&nbsp;&nbsp;&nbsp; --%>
								<a	href="scoreDelete?id=<s:property value="#sv.id"/>">删除</a></td>
							</tr>
						</s:iterator>
				...
				<script>
                 ...
                 function queryName(){
                     ...
                     form.action = "userScoreQuery"+"?userAccount="+search;
                	 form.method = "post";
                	 form.submit();
                 }
                 function add(){
                	 window.location.href="scoreAddQueryAction";
                 }
