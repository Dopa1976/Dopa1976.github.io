           ...
           <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
			...
			<div class="off-canvas-content" data-off-canvas-content">
				...
				<div id="app" >
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 18%;">
						<div class="panel-heading">
							<h3 class="panel-title" STYLE="margin-left: 730px">菜单管理</h3>
						</div>

						<div STYLE="width:25%; height: 50%;float:left; margin-top:20px;margin-left: 50px;" >
							<form >
							 <div style="float: left;line-height: 30px;font-size: 15px;">搜索菜单：</div> 
								<label>
						...
						<div STYLE="width:8%; height: 50%; float: left; margin-top:20px;" >
						     <input type="button" value="添加" class="btn btn-primary" onclick="window.location='menuAddQueryAction'"/>
						</div>
					</div>
					...
					<table class="table table-bordered table-hover table-striped">
						...
						<s:iterator var="menu1" value="menuList" status="st">
							<tr>
								<td><s:property value="#st.index+1" /></td>
								<td><s:property value="#menu1.menuName" /></td>
								<td><s:property value="#menu1.sortNo" /></td>
								<td><s:property value="#menu1.menu.menuName"/></td>
								<td><s:property value="#menu1.address" /></td>
								<td>
								<a href="menuQuMoAction?ids=<s:property value='#menu1.id'/>">修改</a>&nbsp;&nbsp;&nbsp;
								<a href="menuDeleteAction?ids=<s:property value="#menu1.id"/>">删除</a>
				...
				<script>
                 ...
                 function queryName(){
                     ...
                     form.action = "menuQueryNameAction"+"?menuName="+search;
                	 form.method = "post";
                	 form.submit();
                 }
