			...
			<div class="off-canvas-content" data-off-canvas-content>
				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
                       ...
                       <s:form action="scoreAddAction" method="post" theme="simple" >   
                         
                          <table>
                          <tr>
                            <td align="right">用户名:</td>
                            <td>
                            <s:textfield name="userAccount" cssClass="courseText"></s:textfield>
                            </td>
                          </tr>
                          <tr>
                             <td align="right">成绩：</td>
                             <td>
                              <s:textfield  name="scores" cssClass="courseText"></s:textfield>
                             </td>
                          </tr>
                          <tr>
                              <td align="right">批次:</td>
                              <td>
                                  <s:select name="batchId" list="batchs" listKey="id" listValue="batchName" cssStyle="height:30px;width:200px;"></s:select>
                              </td>
                          </tr>
                          <tr>
                             ...
                             <s:submit value="添加" cssClass="update"></s:submit>
                                &nbsp;&nbsp;&nbsp;
                              <input type="button" onclick="sback()" value="返回" class="update"/>
                           </tr>
                          </table>
...
function sback(){
	window.location.href="scoreQueryAll";
}
