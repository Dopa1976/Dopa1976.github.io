			...
			<div class="off-canvas-content" data-off-canvas-content>
				...
				<div id="app" style="height: 590px">
					...
					<div class="panel panel-primary" STYLE="width: 100%; height: 8%;">
                       ...
                       <s:form action="scoreModifyAction" method="post" theme="simple" >   
                         <s:hidden name="id"></s:hidden>
                          <table>
                          <tr>
                            <td align="right">用户名:</td>
                            <td>
                            <s:textfield disabled="true" name="userAccount" cssClass="courseText"></s:textfield>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              ...
                              <td>
                                  <s:textfield disabled="true" name="batchName" cssClass="courseText"></s:textfield>
                              </td>
                          </tr>
                          <tr>
